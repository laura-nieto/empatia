...
class ClimaSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('clima_laboral')->insert([
            ...
            ['pregunta' => 'En la empresa participo en la toma de decisiones'],
            ...
            ['pregunta' => 'En mi equipo de trabajo, puedo expresar mi punto de vista, aún cuando contradiga al de los demás miembros.'],
